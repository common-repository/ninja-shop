...
<?php if ( it_exchange( 'coupons', 'accepting', array( 'type' => 'cart' ) ) || it_exchange( 'coupons', 'has-applied', array( 'type' => 'cart' ) ) ) : ?>
	<?php do_action( 'ninja_shop_super_widget_checkout_before_single_item_update_coupons_action' ); ?>
	...
	<?php do_action( 'ninja_shop_super_widget_checkout_after_single_item_update_coupons_action' ); ?>
<?php endif; ?>
