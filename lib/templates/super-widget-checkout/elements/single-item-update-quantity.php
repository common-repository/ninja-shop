...
<?php if ( it_exchange_get_global( 'can_edit_purchase_quantity' ) ) : ?>
	<?php do_action( 'ninja_shop_super_widget_checkout_before_single_item_update_quantity_element' ); ?>
	...
	<?php do_action( 'ninja_shop_super_widget_checkout_after_single_item_update_quantity_element' ); ?>
<?php endif; ?>
