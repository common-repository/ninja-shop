...
<?php do_action( 'ninja_shop_super_widget_shipping_address_before_actions_loop' ); ?>
<?php do_action( 'ninja_shop_super_widget_shipping_address_begin_actions_loop' ); ?>
<?php foreach ( it_exchange_get_template_part_elements( 'super_widget_shipping-address', 'actions', array( 'submit', 'cancel' ) ) as $action ) : ?>
	...
	?>
<?php endforeach; ?>
<?php do_action( 'ninja_shop_super_widget_shipping_address_end_actions_loop' ); ?>
<?php do_action( 'ninja_shop_super_widget_shipping_address_after_actions_loop' ); ?>
