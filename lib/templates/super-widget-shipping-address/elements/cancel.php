 ...
 * cancel element in the shipping-address
...
*/
?>
<?php do_action( 'ninja_shop_super_widget_shipping_purchase_requirement_before_cancel_element' ); ?>
<div class="ninja-shop-cancel-element">
	<?php it_exchange( 'shipping', 'cancel' ); ?>
</div>
<?php do_action( 'ninja_shop_super_widget_shipping_purchase_requirement_after_cancel_element' ); ?>
