...
*/
?>
<?php do_action( 'ninja_shop_super_widget_shipping_address_purchase_requirement_before_state_element' ); ?>
<div class="ninja-shop-state">
	<?php it_exchange( 'shipping', 'state' ); ?>
</div>
<?php do_action( 'ninja_shop_super_widget_shipping_address_purchase_requirement_after_state_element' ); ?>
