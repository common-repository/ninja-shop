...
*/
?>
<?php do_action( 'ninja_shop_super_widget_shipping_address_purchase_requirement_before_zip_element' ); ?>
<div class="ninja-shop-zip">
	<?php it_exchange( 'shipping', 'zip' ); ?>
</div>
<?php do_action( 'ninja_shop_super_widget_shipping_address_purchase_requirement_after_zip_element' ); ?>
