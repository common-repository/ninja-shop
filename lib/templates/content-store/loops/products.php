...
<?php do_action( 'ninja_shop_content_store_before_products_loop' ); ?>
<ul class="ninja-shop-products">
	<?php do_action( 'ninja_shop_content_store_begin_products_loop' ); ?>
	...
	<?php endif; ?>
	<?php do_action( 'ninja_shop_content_store_end_product_loops' ); ?>
</ul>
<?php do_action( 'ninja_shop_content_store_after_products_loop' ); ?>
