...
<?php do_action( 'ninja_shop_content_checkout_before_line_items' ); ?>
	<div id="ninja-shop-line-items" class="ninja-shop-table">
		<?php do_action( 'ninja_shop_content_checkout_before_line_items_loop' ); ?>

		<?php while ( it_exchange( 'cart', 'line-items', array( 'without' => 'product' ) ) ): ?>
			<?php do_action( 'ninja_shop_content_checkout_begin_line_items_loop' ); ?>
			...
			<?php do_action( 'ninja_shop_content_checkout_end_line_items_loop' ); ?>
		<?php endwhile; ?>

		<?php do_action( 'ninja_shop_content_checkout_after_line_items_loop' ); ?>
	</div>
<?php do_action( 'ninja_shop_content_checkout_after_line_items' ); ?>
