...
*/
?>
<?php do_action( 'ninja_shop_content_checkout_purchase_requirement_billing_before_actions_loop' ); ?>
<?php foreach ( it_exchange_get_template_part_elements( 'content_checkout/elements/purchase-requirements/billing-address/elements/', 'actions', array( 'submit', 'clearfix', 'cancel' ) ) as $action ) : ?>
	...
	?>
<?php endforeach; ?>
<?php do_action( 'ninja_shop_content_checkout_purchase_requirement_billing_after_actions_loop' ); ?>
