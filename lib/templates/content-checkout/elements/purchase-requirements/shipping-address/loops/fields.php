 ...
 */
?>
<?php do_action( 'ninja_shop_content_checkout_shipping_address_purchase_requirement_before_fields_loop' ); ?>
<div class="ninja-shop-checkout-address-form ninja-shop-checkout-address-form--shipping" <?php echo it_exchange( 'shipping', 'saved' ) ? ' style="display: none;"' : ''; ?>>
	<?php $fields = array(
		'first_name',
		'last_name',
		'address_1',
...
<?php do_action( 'ninja_shop_content_checkout_shipping_address_purchase_requirement_after_fields_loop' ); ?>
