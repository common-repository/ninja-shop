...
*/
?>
<?php do_action( 'ninja_shop_content_checkout_purchase_requirement_shipping_before_actions_loop' ); ?>
<?php foreach ( it_exchange_get_template_part_elements( 'content_checkout/elements/purchase-requirements/shipping-address/elements/', 'actions', array( 'submit', 'clearfix', 'cancel' ) ) as $action ) : ?>
	...
	?>
<?php endforeach; ?>
<?php do_action( 'ninja_shop_content_checkout_purchase_requirement_shipping_after_actions_loop' ); ?>
