...
*/
?>
<?php do_action( 'ninja_shop_content_checkout_shipping_address_purchase_requirement_before_address1_element' ); ?>
<div class="ninja-shop-address1 ninja-shop-clear-left">
	<?php it_exchange( 'shipping', 'address1' ); ?>
</div>
<?php do_action( 'ninja_shop_content_checkout_shipping_address_purchase_requirement_after_address1_element' ); ?>
