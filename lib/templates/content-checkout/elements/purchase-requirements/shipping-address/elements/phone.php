...
*/
?>
<?php do_action( 'ninja_shop_content_checkout_shipping_address_purchase_requirement_before_phone_element' ); ?>
<div class="ninja-shop-phone">
	<?php it_exchange( 'shipping', 'phone' ); ?>
</div>
<?php do_action( 'ninja_shop_content_checkout_shipping_address_purchase_requirement_after_phone_element' ); ?>
