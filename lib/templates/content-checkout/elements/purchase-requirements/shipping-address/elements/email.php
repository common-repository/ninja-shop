...
*/
?>
<?php do_action( 'ninja_shop_content_checkout_shipping_address_purchase_requirement_before_email_element' ); ?>
<div class="ninja-shop-email">
	<?php it_exchange( 'shipping', 'email' ); ?>
</div>
<?php do_action( 'ninja_shop_content_checkout_shipping_address_purchase_requirement_after_email_element' ); ?>
