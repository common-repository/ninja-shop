...
*/
?>
<?php do_action( 'ninja_shop_content_checkout_logged_in_purchase_requirement_not_logged_in_before_registration_element' ); ?>
<div class="<?php echo it_exchange_is_checkout_mode( 'registration' ) ? '' : 'ninja-shop-hidden'; ?> checkout-purchase-requirement-registration">
	<?php do_action( 'ninja_shop_content_checkout_logged_in_purchase_requirement_not_logged_in_begin_registration_element' ); ?>
	<?php
	$reg_loops = array( 'fields', 'actions' );

	if ( it_exchange( 'registration', 'is-enabled' ) ) :
		do_action( 'ninja_shop_content_checkout_logged_in_checkout_requirement_registration_before_form' );
		...
		do_action( 'ninja_shop_content_checkout_logged_in_purchase_requirement_registration_after_form' );
	endif;
	?>
	<?php do_action( 'ninja_shop_content_checkout_logged_in_purchase_requirement_not_logged_in_end_registration_element' ); ?>
	<?php //it_exchange_get_template_part( 'content', 'checkout/elements/purchase-requirements/logged-in/loops/not-logged-in/links' ); ?>
</div>
<?php do_action( 'ninja_shop_content_checkout_logged_in_purchase_requirement_not_logged_in_after_registration_element' ); ?>
