...
*/
?>
<?php do_action( 'ninja_shop_content_checkout_logged_in_purchase_requirement_registration_before_password2_element' ); ?>
<div class="ninja-shop-registration-password2">
	<?php it_exchange( 'registration', 'password2' ); ?>
</div>
<?php do_action( 'ninja_shop_content_checkout_logged_in_purchase_requirement_registration_after_password2_element' ); ?>
