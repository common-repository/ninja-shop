...
<?php do_action( 'ninja_shop_content_account_before_content_loop' ); ?>
	<div class="ninja-shop-customer-info">
	<?php do_action( 'ninja_shop_content_account_begin_content_loop' ); ?>
		<?php foreach ( it_exchange_get_template_part_elements( 'content_account', 'content', array( 'welcome', ) ) as $element ) : ?>
			...
			*/
			...
			?>
		<?php endforeach; ?>
	<?php do_action( 'ninja_shop_content_account_end_content_loop' ); ?>
	</div>
<?php do_action( 'ninja_shop_content_account_after_content_loop' ); ?>
