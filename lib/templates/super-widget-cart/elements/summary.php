...
<?php do_action( 'ninja_shop_super_widget_cart_before_summary_element' ); ?>
<div class="item-count">
	<?php do_action( 'ninja_shop_super_widget_cart_begin_summary_element' ); ?>
	<?php if ( $count === 1 ) : ?>
	...
	<?php endif; ?>
	<?php do_action( 'ninja_shop_super_widget_cart_end_summary_element' ); ?>
</div>
<?php do_action( 'ninja_shop_super_widget_cart_after_summary_element' ); ?>
