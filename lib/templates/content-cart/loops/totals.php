...
<?php do_action( 'ninja_shop_content_cart_before_totals' ); ?>
<div id="ninja-shop-cart-totals" class="ninja-shop-table">
<?php do_action( 'ninja_shop_content_cart_before_totals_loop' ); ?>
<?php do_action( 'ninja_shop_content_cart_begin_totals_loop' ); ?>
<?php foreach ( it_exchange_get_template_part_elements( 'content_cart', 'totals', array( 'totals-subtotal', 'totals-savings', 'totals-taxes' ) ) as $total ) : ?>
	...
	<?php endif; ?>
<?php endforeach; ?>
<?php do_action( 'ninja_shop_content_cart_end_totals_loop' ); ?>
<?php do_action( 'ninja_shop_content_cart_before_totals_loop' ); ?>
</div>
<?php do_action( 'ninja_shop_content_cart_after_totals' ); ?>
