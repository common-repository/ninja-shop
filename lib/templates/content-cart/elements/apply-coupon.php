...
<?php do_action( 'ninja_shop_content_cart_before_apply_coupon_element' ); ?>
<?php if ( it_exchange( 'coupons', 'supported', array( 'type' => 'cart' ) ) && it_exchange( 'coupons', 'accepting', array( 'type' => 'cart' ) ) ) : ?>
	<?php do_action( 'ninja_shop_content_cart_begin_apply_coupon_element' ); ?>
	<div class="ninja-shop-cart-apply-coupons">
	...
	<?php do_action( 'ninja_shop_content_cart_end_apply_coupon_element' ); ?>
<?php endif; ?>
<?php do_action( 'ninja_shop_content_cart_after_apply_coupon_element' ); ?>
