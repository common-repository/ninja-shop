...
<?php do_action( 'ninja_shop_content_registration_before_wrap' ); ?>
<div id="ninja-shop-registration" class="ninja-shop-wrap ninja-shop-account">
<?php do_action( 'ninja_shop_content_registration_begin_wrap' ); ?>
	...
	<?php else : ?>
		<?php if ( it_exchange( 'registration', 'is-enabled' ) ) : ?>
			<?php do_action( 'ninja_shop_content_registration_before_form' ); ?>
			...
			<?php do_action( 'ninja_shop_content_registration_after_form' ); ?>
		<?php else : ?>
			<?php it_exchange_get_template_part( 'content-registration/elements/registration-disabled-message' ); ?>
		<?php endif; ?>
	<?php endif; ?>
<?php do_action( 'ninja_shop_content_registration_end_wrap' ); ?>
</div>
<?php do_action( 'ninja_shop_content_registration_after_wrap' ); ?>
