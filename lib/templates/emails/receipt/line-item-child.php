<?php
/**
 * This file contains the markup for the receipt email line item child.
 *
 * 
		...
		<table>
			<tr>
				<td style="font-size: 80%;">
					<?php do_action( 'ninja_shop_email_template_receipt_cart-details_before_product_name' ); ?>
					&ndash; <?php it_exchange( 'line-item', 'name' ); ?><br>
					<?php do_action( 'ninja_shop_email_template_receipt_cart-details_after_product_name' ); ?>
