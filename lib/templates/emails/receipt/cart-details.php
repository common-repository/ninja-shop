			...
			<tr>
				<td valign="top" style="padding: 20px 25px; ">
					<table width="100%" style="line-height: 1.2;">
						<?php do_action( 'ninja_shop_email_template_receipt_cart-details_before_header_row' ); ?>
						<tr>
						...
						<?php do_action( 'ninja_shop_email_template_receipt_cart-details_after_header_row' ); ?>

						<?php do_action( 'ninja_shop_email_template_receipt_cart-details_begin_line_items' ); ?>
						<?php while ( it_exchange( 'transaction', 'line-items' ) ): ?>
							...
							<?php endif; ?>
						<?php endwhile; ?>
						<?php do_action( 'ninja_shop_email_template_receipt_cart-details_end_line_items' ); ?>
					</table>
				</td>
			</tr>
		</table>
