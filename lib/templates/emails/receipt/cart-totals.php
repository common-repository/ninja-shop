			...
			<tr>
				<td valign="top" style="padding: 0 25px;">
					<table width="100%" style="line-height: 1.2;">
						<?php do_action( 'ninja_shop_email_template_receipt_cart-totals_before_subtotal' ); ?>
						<tr>
							<td></td>
						...
						<?php do_action( 'ninja_shop_email_template_receipt_cart-totals_after_subtotal' ); ?>

						<?php while ( it_exchange( 'transaction', 'totals' ) ) : ?>
							<?php do_action( 'ninja_shop_email_template_receipt_cart-totals_before_' . it_exchange( 'transaction', 'get-total-line', 'field=type' ) ); ?>
							<tr>
								<td></td>
							...
							<?php do_action( 'ninja_shop_email_template_receipt_cart-totals_after_'. it_exchange( 'transaction', 'get-total-line', 'field=type' ) ); ?>
						<?php endwhile; ?>

						<?php do_action( 'ninja_shop_email_template_receipt_cart-totals_before_total' ); ?>
						<tr>
							<td></td>
							<td align="right" style="padding: 10px; ">
						...
						<?php do_action( 'ninja_shop_email_template_receipt_cart-totals_after_total' ); ?>
					</table>
				</td>
			</tr>
		</table>
