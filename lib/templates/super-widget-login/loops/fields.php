...
<?php do_action( 'ninja_shop_super_widget_login_before_fields_loop' ); ?>
<?php do_action( 'ninja_shop_super_widget_login_begin_fields_loop' ); ?>
<?php foreach( it_exchange_get_template_part_elements( 'super_widget_login', 'fields', array( 'username', 'password', 'rememberme' ) ) as $field ) : ?>
	...
	?>
<?php endforeach; ?>
<?php do_action( 'ninja_shop_super_widget_login_end_fields_loop' ); ?>
<?php do_action( 'ninja_shop_super_widget_login_after_fields_loop' ); ?>
