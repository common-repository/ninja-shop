...
<?php do_action( 'ninja_shop_content_purchases_before_product_featured_image_element' ); ?>
<?php it_exchange( 'transaction', 'product-featured-image' ); ?>
<?php do_action( 'ninja_shop_content_purchases_after_product_featured_image_element' ); ?>
