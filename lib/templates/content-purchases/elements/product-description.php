...
<?php do_action( 'ninja_shop_content_purchases_before_product_description_element' ); ?>
<p><?php it_exchange( 'transaction', 'product-attribute', array( 'attribute' => 'description' ) ); ?></p>
<?php do_action( 'ninja_shop_content_purchases_after_product_description_element' ); ?>
