...
<?php do_action( 'ninja_shop_content_purchases_before_transaction_info_loop' ); ?>
<?php do_action( 'ninja_shop_content_purchases_begin_transaction_info_loop' ); ?>
...
<?php endforeach; ?>
<?php do_action( 'ninja_shop_content_purchases_end_transaction_info_loop' ); ?>
<?php do_action( 'ninja_shop_content_purchases_after_transaction_info_loop' ); ?>
