...
<?php do_action( 'ninja_shop_content_purchases_before_transactions_loop' ); ?>
<?php while ( it_exchange( 'transactions', 'exist' ) ) : ?>
	<?php do_action( 'ninja_shop_content_purchases_begin_transactions_loop' ); ?>
	<div class="ninja-shop-purchase">
		<div class="ninja-shop-purchase-top ninja-shop-transaction-info">
	...
	<?php do_action( 'ninja_shop_content_purchases_end_transactions_loop' ); ?>
<?php endwhile; ?>
<?php do_action( 'ninja_shop_content_purchases_after_transactions_loop' ); ?>
