...
<?php do_action( 'ninja_shop_content_profile_before_actions_loop' ); ?>
	<div class="ninja-shop-customer-actions">
	<?php do_action( 'ninja_shop_content_profile_begin_actions_loop' ); ?>
		<?php foreach ( it_exchange_get_template_part_elements( 'content_profile', 'actions', array( 'save' ) ) as $action ) : ?>
			...
			*/
			...
			?>
		<?php endforeach; ?>
	<?php do_action( 'ninja_shop_content_profile_end_actions_loop' ); ?>
	</div>
<?php do_action( 'ninja_shop_content_profile_after_actions_loop' ); ?>
