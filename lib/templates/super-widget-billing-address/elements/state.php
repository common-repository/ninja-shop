...
*/
?>
<?php do_action( 'ninja_shop_super_widget_billing_address_purchase_requirement_before_state_element' ); ?>
<div class="ninja-shop-state">
	<?php it_exchange( 'billing', 'state' ); ?>
</div>
<?php do_action( 'ninja_shop_super_widget_billing_address_purchase_requirement_after_state_element' ); ?>
