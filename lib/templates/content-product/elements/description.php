...
<?php if ( it_exchange( 'product', 'has-description' ) ) : ?>
	<?php do_action( 'ninja_shop_content_product_before_description_element' ); ?>
	<div class="ninja-shop-product-description">
		<?php it_exchange( 'product', 'description' ); ?>
	</div>
	<?php do_action( 'ninja_shop_content_product_after_description_element' ); ?>
<?php endif; ?>
