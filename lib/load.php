<?php
/**
 * This file loads the Ninja Shop Framework
 *
 *
 * @package IT_Exchange
 */
...
// WordPress Privacy and Personal Data
require_once __DIR__ . '/personal-data/load.php';

require_once __DIR__ . '/telemetry/load.php';

if ( defined( 'WP_CLI' ) && WP_CLI ) {
	require_once __DIR__ . '/cli/load.php';
}

require_once __DIR__ . '/blocks/includes/load.php';
