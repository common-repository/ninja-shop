...
class IT_Exchange_Product_Feature_Product_Order {
	...
	*/
	function __construct() {
		...
		add_action( 'ninja_shop_update_product_feature_product-order', array( $this, 'save_feature' ), 9, 2 );
		add_filter( 'ninja_shop_get_product_feature_product-order', array( $this, 'get_feature' ), 9, 2 );
		add_filter( 'ninja_shop_product_has_feature_product-order', array( $this, 'product_has_feature') , 9, 2 );
		add_filter( 'ninja_shop_product_supports_feature_product-order', array( $this, 'product_supports_feature') , 9, 2 );
	}
	...
	*/
	function print_metabox( $post ) {
		...
		$description = apply_filters( 'ninja_shop_product_product-order_metabox_description', $description );
	...
	*/
	function save_feature_on_product_save() {
		...
		$new_value = sanitize_text_field( $_POST['it-exchange-product-product-order'] );
