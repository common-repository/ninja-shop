...
<?php do_action( 'ninja_shop_super_widget_guest_checkout_before_actions_loop' ); ?>
<?php do_action( 'ninja_shop_super_widget_guest_checkout_begin_actions_loop' ); ?>
<?php foreach ( it_exchange_get_template_part_elements( 'super_widget_guest_checkout', 'actions', array( 'save', 'cancel' ) ) as $action ) : ?>
	...
	?>
<?php endforeach; ?>
<?php do_action( 'ninja_shop_super_widget_guest_checkout_end_actions_loop' ); ?>
<?php do_action( 'ninja_shop_super_widget_guest_checkout_after_actions_loop' ); ?>
