...
*/
?>
<?php do_action( 'ninja_shop_super_widget_guest_checkout_before_wrap' ); ?>
<div class="guest-checkout it-exchange-sw-processing-guest-checkout it-exchange-sw-processing">
	<?php do_action( 'ninja_shop_super_widget_guest_checkout_begin_wrap' ); ?>
	...
	<div class="ninja-shop-guest-checkout-form-wrapper it-exchange-clearfix">
		<form class="ninja-shop-guest-checkout-form" method="post" action="">
	...
	<?php do_action( 'ninja_shop_super_widget_guest_checkout_end_wrap' ); ?>
</div>
<?php do_action( 'ninja_shop_super_widget_guest_checkout_after_wrap' ); ?>
