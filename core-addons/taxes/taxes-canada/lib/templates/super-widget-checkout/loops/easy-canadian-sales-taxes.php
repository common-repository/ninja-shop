...
<?php do_action( 'ninja_shop_super_widget_checkout_before_easy_canadian_sales_taxes_element' ); ?>
<div class="cart-taxes cart-totals-row">
	<?php do_action( 'ninja_shop_super_widget_checkout_begin_easy_canadian_sales_taxes_element' ); ?>
	<?php _e( 'Tax', 'LION' ) . _x( ':', 'Used in superwidget for taxes. eg Tax: ', 'LION' ); ?> 
	<?php it_exchange( 'canadian-taxes', 'taxes' ); ?>
	<?php do_action( 'ninja_shop_super_widget_checkout_end_easy_canadian_sales_taxes_element' ); ?>
</div>
<?php do_action( 'ninja_shop_super_widget_checkout_after_easy_canadian_sales_taxes_element' ); ?>
