...
add_action( 'ninja_shop_register_tax_providers', 'it_exchange_register_canadian_taxes_provider' );
...
add_action( 'ninja_shop_add_transaction_success', 'it_exchange_easy_canadian_sales_taxes_transaction_hook', 10, 2 );
/**
...
add_action( 'ninja_shop_replace_order_table_tag_before_total_row', 'it_exchange_easy_canadian_sales_taxes_replace_order_table_tag_before_total_row', 10, 2 );