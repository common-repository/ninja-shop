...
<?php do_action( 'ninja_shop_content_checkout_before_easy_eu_valued_added_taxes_element' ); ?>
...
<?php do_action( 'ninja_shop_content_checkout_after_easy_eu_valued_added_taxes_element' ); ?>
