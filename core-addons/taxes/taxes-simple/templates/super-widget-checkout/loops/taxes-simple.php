...
*/
?>
<?php do_action( 'ninja_shop_super_widget_checkout_before_taxes_simple_element' ); ?>
<div class="cart-taxes cart-totals-row">
	<?php do_action( 'ninja_shop_super_widget_checkout_begin_taxes_simple_element' ); ?>
	...
	<?php do_action( 'ninja_shop_super_widget_checkout_end_taxes_simple_element' ); ?>
</div>
<?php do_action( 'ninja_shop_super_widget_checkout_after_taxes_simple_element' ); ?>
